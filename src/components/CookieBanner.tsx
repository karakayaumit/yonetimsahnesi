      ...
      <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex-1">
            <h3 className="text-sm font-semibold text-gray-900 mb-1">Çerez Onayı</h3>
            <p id="cookie-banner-description" className="text-sm text-gray-600">
              Sitemizde çerezler kullanıyoruz. Ziyaretçilerin sitemizle, ürün ve hizmetlerimizle nasıl etkileşime girdiğine dair veri toplamak için çerezler gibi araçlardan yararlanıyoruz. Kabul Et'e tıklayarak bu araçların reklam, analitik ve destek amaçlı kullanımını onaylıyorsunuz.
            </p>
          </div>
          <div className="flex items-center gap-3 flex-shrink-0">
            <Button size="sm" variant="secondary" onClick={() => saveConsent(false)} className="whitespace-nowrap">Reddet</Button>
            <Button size="sm" onClick={() => saveConsent(true)} className="whitespace-nowrap" autoFocus>Kabul Et</Button>
          </div>
        </div>
      </div>
    </div>
